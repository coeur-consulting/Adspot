...
<template>
    <div class="bg-gray-100 p-2 md:p-4">
        ...
        <div class="container mx-auto md:flex items-center text-center">
            <div
                class="px-1 md:px-3 py-1 rounded-full md:mr-5 capitalize text-xs cursor-pointer"
                @click="setCategory(0)"
                :class="
            ...
            <div
                class="px-1 md:px-3 py-1 text-xs rounded-full md:mr-5 capitalize cursor-pointer"
