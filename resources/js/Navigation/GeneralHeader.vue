...
<template>
  <Popover
    ...
    "
  >
    <div class="px-4 lg:px-0 max-w-screen-xl mx-auto h-full">
      <div class="flex justify-between items-center h-full">
        ...
        <div class="hidden lg:flex items-center justify-end">
           <!-- Notiifcations dropdown -->
            <Popover v-slot="{ openNotification }" class="relative" v-if="$page.props.auth.user">
              <PopoverButton
              ...
              >
               ...
               <span class="relative">
                  <BellIcon class="h-6 w-6 text-white  hover:text-gray-400" aria-hidden="true" />
