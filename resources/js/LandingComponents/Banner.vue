    ...
    <section id="banner" class="relative h-[92vh] group">
        ...
        >
            <slide v-for="(item, index) in banners" :key="index" class="group">
                <img
                    class="h-full md:h-[92vh] w-full kenburns-top-right"
                    :src="item"
                />
            </slide>
        ...
        >
            ...
            >
                <h1 class="text-white text-3xl font-extrabold mb-4">
                    ...
                    advertising spaces and brand solutions
                </h1>
                <div class="banner_m text-left mb-6">
                    <p class="leading-normal text-white">
                        We exist to help advertisers and agencies find,
                        negotiate and pay for advertising spaces easily and
                        transparently. We also provide data and insight that
                        help our clients make informed decisions and reach their
                        target audience efficiently and effectively.
                    </p>
                </div>
                <div class="md:hidden">
                    <Link href="/inventory?toggle=search">
                        <button
                            type="button"
                            class="px-4 py-2 border border-transparent rounded-full shadow-lg text-xs text-white bg-orange-500 focus:ring-2 focus:ring-inset focus:ring-orange-500 flex items-center"
                        >
                            <span class="mr-2 text-white font-bold"
            ...
            <div class="absolute bottom-10 z-20 right-10 flex items-center">
                ...
                <span
                    class="carousel_line grid grid-cols-2 mx-2 rounded-full overflow-hidden"
                >
                    <span
