                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            class="flex items-center"
                                ...
                                "
                                >{{ item.name }} <span class="bg-white rounded-full text-gray-700 ml-1 text-[0.6rem] flex items-center justify-center w-3 h-3"  v-if="item.href === '/all-offers' && offerCount">{{offerCount}}</span></a
                            >
                        </div>
                    </div>
                </div>
                <div class="hidden md:block">
                    <div class="ml-4 flex items-center md:ml-6">
                        ...
                        <Popover v-slot="{ openNotification }" class="relative">
                            <PopoverButton
                                :class="
                                    openNotification ? '' : 'text-opacity-90'
                                "
                            ...
                            >
                                ...
                                <span
                                    class="py-[.01rem] px-1 text-xs bg-red-500 text-white absolute top-[-1px] right-[-1px] rounded-lg"
                            ...
                            >
                                <PopoverPanel
                                    class="absolute z-40 w-[300px] max-w-sm p-4 mt-3 right-0 sm:px-0 lg:max-w-sm bg-white rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 py-4"
                                >
                                    <div class="overflow-hidden">
                                        <h6 class="mb-2 font-black px-4">
                                            Notifications
                                        </h6>
                                        <hr />
                                        <ul
                                            class="px-4 max-h-[450px] overflow-auto"
                                        >
                                            <li
                                        ...
                                        <div class="text-center">
                                            <Link href="/admin/notifications">
                                                <span
                                                    class="text-xs mx-auto cursor-pointer"
                                                    >View all</span
                                                ></Link
                                            >
                                        </div>
        ...
        <DisclosurePanel class="md:hidden">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                class="flex items-center"
                    ...
                    >{{ item.name }}  <span class="bg-white rounded-full text-gray-700 ml-1 text-[0.6rem] flex items-center justify-center w-3 h-3"  v-if="item.href === '/all-offers' && offerCount">{{offerCount}}</span></DisclosureButton
                >
            </div>
...
export default {
    ...
    setup() {
        ...
        onMounted(() => {
            axios.get("/pending-offers").then((res) => {
                offerCount.value = res.data;
            });
